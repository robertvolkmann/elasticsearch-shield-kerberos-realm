...
public class KerberosTokenTest {
    ...
    public void should_not_create_a_token_when_header_is_null() {
        assertThat(new KerberosToken.KerberosTokenFactory().extractToken(null), is(nullValue()));
    }
    ...
    public void should_throw_elasticsearch_exception_when_header_not_start_with_negotiate() {
        ...
        new KerberosToken.KerberosTokenFactory().extractToken("something");
    }
    ...
    public void should_return_a_token() {
        ...
        KerberosToken token = new KerberosToken.KerberosTokenFactory().extractToken(header);
